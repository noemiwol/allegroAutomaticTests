    ...
    describe("MediaExpert Product Search", async () =>{
        it("should open the main url and close alert verfi the title",async () => {
            ...
            const alertBtn:WebdriverIO.Element = await $("//*[@id='spark']/div[3]/div[1]/div/button");
        ...
        it("search for a product and verify the search text value and redirect to new page and verify the title " , async() =>{
            const searchInput:WebdriverIO.Element = await $("//*[@id='section_header-desktop']/div/div/div[2]/div/form/div[1]/input");
            const searchBtn:WebdriverIO.Element = await $("//*[@id='section_header-desktop']/div/div/div[2]/div/form/button/span/i");
